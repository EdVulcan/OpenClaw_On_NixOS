  ...
  const pluginSdkContract = createOpenClawNativePluginContract({
    ...
    capabilities: [
      ...
      },
      {
        ...
        description: "Creates bounded single, multi-hunk, and structured line-edit previews for OpenClaw workspace edits and applies them only after explicit approval through native filesystem governance.",
        kind: "act",
        domains: ["body_internal"],
        risk: "high",
        permissions: {
