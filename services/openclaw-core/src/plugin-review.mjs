...
export function createPluginReview(deps) {
  ...
  const {
    ...
    buildOpenClawPluginSearchWebAdapterProviderRuntimeSandboxTaskDraft: (...args) => buildOpenClawPluginSearchWebAdapterProviderRuntimeSandboxTaskDraft(...args),
    buildOpenClawPluginSearchWebAdapterRuntimeActivationTaskDraft: (...args) => buildOpenClawPluginSearchWebAdapterRuntimeActivationTaskDraft(...args),
    buildOpenClawPluginSearchWebAdapterTaskDraft: (...args) => buildOpenClawPluginSearchWebAdapterTaskDraft(...args),
    createApprovalRequestForTask,
    createTask,
    persistState,
    publishEvent,
