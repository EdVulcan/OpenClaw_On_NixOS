...
export const NATIVE_ENGINEERING_TOOL_CONTRACTS = [
  ...
  },
  {
    ...
    intendedNativeCapabilityId: "sense.openclaw.engineering_tool.lsp_evidence / act.openclaw.engineering_tool.lsp_lifecycle_task / sense.openclaw.engineering_tool.lsp_lifecycle_state",
    operationClass: "language_intelligence_evidence_and_governed_lifecycle_state",
    riskLevel: "medium",
    domain: "workspace_engineering",
    approvalExpectation: "not_required_for_evidence_or_state_readback; lifecycle execution requires explicit approval",
    ...
    migrationStatus: "partially_absorbed_lifecycle_state_readback",
    deferredExecutionBoundary: "source-content transfer, LSP JSON-RPC requests, long-lived process pools, package installation, provider egress, and root/system daemon work remain deferred",
    expectedSourcePaths: [
