...
That should attach verification command proposal/evidence readback to the
selected-target edit flow after manual approval/execution without adding
another standalone readiness chain.
