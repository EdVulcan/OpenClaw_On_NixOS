...
| Level 2 受信会话组件 | 约 45% | trusted-session 契约、身份一致性、session-manager helper lease、lease 约束的 browser input/click、work-view recovery/readback 已有；takeover lease suspension、外部 sidecar 和更稳定 capture runtime 尚未落地。 |
