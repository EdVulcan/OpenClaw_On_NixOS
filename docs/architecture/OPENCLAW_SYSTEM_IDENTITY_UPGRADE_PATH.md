...
| Level 2 受信会话组件 | 约 50% | trusted-session 契约、身份一致性、session-manager helper lease、lease 约束的 browser input/click、work-view recovery/readback，以及 takeover suspend 与显式 resume/rebind 已有；外部 sidecar、进程 heartbeat 和更稳定 capture runtime 尚未落地。 |
