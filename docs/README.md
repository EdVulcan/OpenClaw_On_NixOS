...
| [OPENCLAW_PHASE_C_KERNEL_PROCESS_EXEC_PLAN.md](./plans/OPENCLAW_PHASE_C_KERNEL_PROCESS_EXEC_PLAN.md) | Completed first Phase C slice: bounded read-only eBPF `sched_process_exec` capture, continuity, and CO-RE executable identity through system-sense, core proxy, and Observer. |
