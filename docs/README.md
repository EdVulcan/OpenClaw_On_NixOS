...
| [OPENCLAW_NATIVE_ENGINEERING_PLAN_TODO_WORKBENCH_STORAGE_PLAN.md](./plans/OPENCLAW_NATIVE_ENGINEERING_PLAN_TODO_WORKBENCH_STORAGE_PLAN.md) | Active governed core-state workbench storage for visible plan/todo state without hidden mode, todo-file writes, task mutation, approvals, commands, or providers. |
