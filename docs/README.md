...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 1 to Level 2 bridge with mediated browser actions, takeover suspension, supervised sidecar heartbeat, fail-closed liveness, and explicit approved restart/rebind. |
