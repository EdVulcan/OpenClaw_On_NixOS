...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 1 to Level 2 bridge with a session-manager owned helper lease matched by browser-runtime and enforced through screen-act/browser input and click mediation. |
