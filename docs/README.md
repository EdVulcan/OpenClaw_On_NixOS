...
| [OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md](./plans/OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md) | Active Phase B route; native read-only systemd D-Bus inventory is complete, while mutation, Polkit, hostd, and fixed-helper removal remain deferred. |
