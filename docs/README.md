...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 2 bridge with mediated browser actions, approved systemd user sidecar ownership, fail-closed restart/rebind, and the next bounded browser-workspace continuity slice. |
