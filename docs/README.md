...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 2 bridge with systemd user sidecar ownership, fail-closed restart/rebind, bounded browser-workspace continuity, and the next real browser-engine adapter slice. |
