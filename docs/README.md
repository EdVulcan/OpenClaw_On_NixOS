...
| [OPENCLAW_NATIVE_PLUGIN_RUNTIME_REFRESH_TASK_PLAN.md](./plans/OPENCLAW_NATIVE_PLUGIN_RUNTIME_REFRESH_TASK_PLAN.md) | Active approval-gated native plugin refresh task that atomically swaps a validated fixed-registry generation after approval without arbitrary module import, code execution, runtime activation, or cache mutation. |
