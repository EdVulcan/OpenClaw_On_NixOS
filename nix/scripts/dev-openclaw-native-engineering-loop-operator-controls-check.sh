...
for (const token of [
  ...
  "engineering-loop-state-standards",
  "engineering-loop-state-missing",
  "engineering-loop-state-standards-next",
...
for (const token of [
  ...
  "engineeringLoopWorkStandardsQuery",
  "engineeringLoopWorkStandardsNextAction",
  ...
  "/plugins/native-adapter/prompt-semantics?query=\${encodeURIComponent(query)}&limit=24",
  "Next Standards Action:",
