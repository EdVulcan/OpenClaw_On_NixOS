...
const requiredClient = [
  ...
  "postControl(\"/control/resume\")",
  "startTrustedSidecarLifecycleProbe",
  "Restart Approved Trusted Sidecar",
  "Trusted Boundary",
  "Browser Engine:",
  ...
  "renderSemanticTargetSelection",
  "createOperatorReviewedSemanticClickTask",
  "/tasks/plan",
  "browser.semantic_click",
  "targetReferenceMaterialisedAtDispatch",
